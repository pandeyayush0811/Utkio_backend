-- Run this once in Supabase Dashboard -> SQL Editor, after 013_fix_trial_counters_null_guard.sql.
-- Adds independent trial_scenarios_used tracking to profiles and updates consume_access and peek_access.
