 ...
 * @param {number} [options.limit=1000] - maximum recent sessions to fetch
 */
async function getUserStreak(userId, referenceDate = new Date(), options = {}) {
  ...
  const queryLimit = typeof options?.limit === 'number' && options.limit > 0 ? options.limit : 1000;
